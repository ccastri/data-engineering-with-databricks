...
# MAGIC %fs ls /mnt/dbacademy-datasets/data-engineer-learning-path/v04/ecommerce/raw/users-historical
# MAGIC
...
DA.paths.ecommerce_db = f"{DA.paths.working_dir}/ecommerce.db"
datasource_path = "dbfs:/mnt/dbacademy-datasets/data-engineer-learning-path/v04/ecommerce/raw/users-historical"

# Use Spark to read Parquet file directly
df_spark = spark.read.parquet(datasource_path)
